...
using ProgrammersBlog.Shared.Helpers.JsonWritableOption;
...
namespace WebUI.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Contact(EmailSendDto emailSendDto)
        {
            ...
            _toastNotification.AddWarningToastMessage("Beklenmeyen bir hata oluştu. Lütfen daha sonra tekrar deneyiniz.", new ToastrOptions
            {

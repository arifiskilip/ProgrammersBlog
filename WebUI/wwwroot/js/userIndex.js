                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (userListDto.ResultStatus === 0) {
                                ...
                                toastr.error(`${userListDto.Message}`, 'Ýþlem Baþarýsýz!');
                            }
                        },
                        error: function (err) {
                            console.log(err);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            const jqueryTableRow = $(newTableRow);
                            jqueryTableRow.attr('name', `row_${userAddAjaxModel.UserDto.User.Id}`);
                            dataTable.row(newTableRow).draw();
                            toastr.success(`${userAddAjaxModel.UserDto.Message}`, 'Baþarýlý Ýþlem!');
                        } else {
                            let summaryText = "";
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            Swal.fire({
                ...
                text: `${userName} adlý kullanýcý silinicektir!`,
                icon: 'warning',
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (userDto.ResultStatus === 0) {
                                Swal.fire(
                                    'Silindi!',
                                    `${userDto.User.UserName} adlý kullanýcý baþarýyla silinmiþtir.`,
                                    'success'
                                );
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            toastr.success(`${userUpdateAjaxModel.UserDto.Message}`, "Baþarýlý Ýþlem!");
                        } else {
                            let summaryText = "";
                            $('#validation-summary > ul > li').each(function () {
                                let text = $(this).text();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            const tableRow = $(`[name="${id}"]`);
                            //placeHolderDiv.find('.modal').modal('hide');
                            toastr.success(`${userRoleAssignAjaxModel.UserDto.Message}`, "Baþarýlý Ýþlem!");
                        } else {
                            let summaryText = "";
                            $('#validation-summary > ul > li').each(function () {
                                let text = $(this).text();
